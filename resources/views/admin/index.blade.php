...
<html class="x-admin-sm">
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="resources/views/admin/index.blade.php">X-admin v2.2</a></div>
            <div class="left_open">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="resources/views/admin/login.blade.php">退出</a></dd>
                    </dl>
                </li>
            ...
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="resources/views/admin/login.blade.php" target="_blank">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>登录页面</cite></a>
                            </li>
                            <li>
